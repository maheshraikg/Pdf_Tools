...
import com.maheshraikg.pdftoolkit.data.local.RecentFileEntity
...
class SafUriManagerTest {
    ...
    fun persistedFile_conversion_isCorrect() {
        val original = PersistedFile(
            uriString = "content://com.maheshraikg.pdftoolkit.provider/shared_files/shared_123.pdf",
    ...
    fun persistedFile_uriParsing_isCorrect() {
        ...
        assertEquals("com.maheshraikg.pdftoolkit.provider", uri?.authority)
    }
}
