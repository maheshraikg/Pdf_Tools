...
private fun IntroSection() {
    Card(
        ...
        Column(
            ...
            Text(
                text = "PDF Master Tools is built with open source software",
...
private fun AboutSection() {
    val context = LocalContext.current
    val sourceCodeUrl = "https://github.com/maheshraikg/Pdf_Tools"
    ...
    Card(
        ...
        Column(
            ...
            Text(
                text = "About PDF Master Tools",
                style = MaterialTheme.typography.titleSmall,
                fontWeight = FontWeight.Bold,
                color = MaterialTheme.colorScheme.onTertiaryContainer
            )
            Text(
                text = "PDF Master Tools is also open source and available under the Apache License 2.0.",
                style = MaterialTheme.typography.bodyMedium,
                color = MaterialTheme.colorScheme.onTertiaryContainer
            )
