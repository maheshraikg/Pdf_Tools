...
// Play Store upload key. android/key.properties is created by CI from secrets
// (or by hand on your machine) and is never committed.
...
android {
    namespace = "com.aksharaaata.akshara_aata"
    ...
    defaultConfig {
        // Play Store package name. It cannot change after the first upload.
        applicationId = "com.aksharaaata.kannada"
    ...
    buildTypes {
        release {
            // Without key.properties the build falls back to debug keys, which
            // installs fine on a phone but cannot be uploaded to Play.
